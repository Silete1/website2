  ...
  const cardTranslations = {
    ar: {
      'About': {
        title: 'نبذة عنا',
        description:
          'أنو سوفتوير سوليوشنز فريق يضم مهندسين ومحللين يفهمون لغة العمليات ولغة الكود معاً. نطوّر تطبيقات ويب وموبايل مخصّصة، وننفّذ أنظمة أودو ERP عندما تحتاج الشركة إلى هيكلة قوية للعمليات الداخلية. نفضّل العمل كشريك طويل الأمد يواكب تشغيل شركتك، ويطوّر النظام تدريجياً بحيث تبقى التقنية في خدمة العمل لا العكس.',
      },
      'Our Mission': {
        title: 'رسالتنا',
        description:
          'رسالتنا هي استبدال الأساليب العشوائية والعمليات المرهِقة بأنظمة رقمية واضحة، سواء كانت تطبيقاً مخصّصاً، أو نظام أودو ERP، أو حلاً يجمع بينهما بشكل عملي، مع الحفاظ على بساطة الاستخدام لمن يعملون على هذه الأنظمة يومياً.',
      },
      'Our Vision': {
        title: 'رؤيتنا',
        description:
          'رؤيتنا أن نكون الشريك التقني الموثوق للشركات العراقية التي ترغب في رقمنة عملياتها الأساسية باستخدام برمجيات مدروسة ومُتقنة، بعيداً عن الحلول المؤقتة والترقيعية.',
      },
      'Our Approach': {
        title: 'منهجيتنا',
        description:
          'نبدأ بحوارات ورسوم بسيطة توضّح كيف يسير العمل فعلياً داخل شركتك. بعدها نحول ذلك إلى تسلسل واضح للخطوات، ونحدّد ما ينبغي أتمتته، وما إذا كان الأنسب تنفيذه كتطبيق مخصّص أو ضمن نظام الـ ERP. نطوّر نسخة أولى قابلة للاستخدام بسرعة، نتابع كيف يتعامل معها فريقك في الواقع، ثم نحسّنها بتعديلات قصيرة ومركّزة بدلاً من إطلاق ضخم ومخاطرة عالية.',
      },
    },
  };
